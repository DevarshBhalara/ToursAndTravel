          ...
          <nav class="navbar navbar-expand-lg navbar-dark bg-success">
            ...
            <section class="container mt-5 col-sm">
                ...
                <table class="table table-striped  text-center mt-4" >
                    <h3 class="text-center" style="text-transform: uppercase;"> All Day </h3>
                    <tr>
                        <th>Hotel name </th>
                        <th>City </th>
                        <th> State </th>
                    ...
                    <?php
                        ...
                        $id = $_REQUEST['hotel'];
                        $qry = "SELECT total,ref_id_pack,pack_hotel_name,city,state FROM hotel_details WHERE ref_id_pack=".$id ; 
                        //echo  $qry;
                        ...
                        ?>           
                            <tr>
                                ...
                                <td> <a href="editHotelInformation.php?hotel=<?php echo $row[0]; ?>"> Edit</a> </td>
                                <td> <a href="deleteHotelInfo.php?hotel=<?php echo $row[0]; ?>"> Delete</a></td>
                            </tr>
                    <?php
                            }
                        } 
