        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-success">
            ...
            <section class="container mt-5 col-sm">
                ...
                <table class="table table-striped  text-center mt-4" >
                    <h3 class="text-center" style="text-transform: uppercase;"> Use Query</h3>
                    <tr>
                        <th>User Name</th>
                        <th> Mobile Number  </th>
                        <th> Query</th>
                    ...
                    <?php
                            ...
                            $qry = "SELECT user_query.`uid`, user.`name`, user_query.`query` ,user.`mobile_no` QUERY FROM user_query INNER JOIN USER ON user.`uid` = user_query.`uid` "; 
                             //echo  $qry;
