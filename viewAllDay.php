...
?>
    ...
    <html lang="en">
        ...
        <header>
            ...
            <section class="container mt-3 col-sm">
                
                <table class="table table-striped  text-center mt-4" >
                    <h3 class="text-center" style="text-transform: uppercase;"> All Day Information </h3>
                    <tr>
                        <th>Day </th>
                        <th> Day Activity</th>
                        <th> Edit </th>
                    ...
                    <?php
                        ...
                        $id = $_REQUEST['day'];
                        $qry = "SELECT total,ref_pack_id,days_count,days_activity FROM day_wise_info WHERE ref_pack_id=".$id ; 
                        //echo  $qry;
                        ...
                        ?>           
                            <tr>
                                ...
                                <td> <a href="editDayWiseInformation.php?day=<?php echo $row[0]; ?>"> Edit</a> </td>
                                <td> <a href="deleteDayWiseInfo.php?day=<?php echo $row[0]; ?>"> Delete</a></td>
                            </tr>
                    <?php
                            }
                        } 
